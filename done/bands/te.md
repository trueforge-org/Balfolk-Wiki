...
Té heeft dusver één cd uitgebracht in mei 2012 getiteld *Flamingo's Gambit*. Op deze CD staan 12 nummers en zijn ze op 4 nummers als kwartet te horen. De overige nummers spelen ze als trio. Bij het maken van de cd is net als bij de optredens het thema Alice in Wonderland verwerkt. Dit is terug te vinden in de titels van enkele nummers op deze cd zoals *Lullaby for a Cheshire Cat* en *Madhatter & Co*. Ook zijn er meer woordgrapjes terug te vinden op hun CD.
